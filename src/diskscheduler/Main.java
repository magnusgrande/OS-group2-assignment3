 ...
 *
 * <p>Runs {@link FCFSScheduler FCFS}, {@link SSTFScheduler SSTF}, and
 * {@link SCANScheduler SCAN} against three predefined test cases. Results
 * are printed to the console and mirrored to {@code output.txt} in the working
 * directory.
 *
 * <p><b>Test cases:</b>
 * <ol>
 *   <li><em>Standard request queue</em> – general performance comparison.</li>
 *   <li><em>Clustered requests</em> – shows the advantage of choosing nearby
 *       requests.</li>
 *   <li><em>Fairness challenge</em> – demonstrates how SSTF may delay requests
 *       far from the current head position.</li>
 * </ol>
 *
...
public class Main {
    ...
    /**
     * Runs all three scheduling algorithms against each test case, prints
     * results to stdout, and writes the same output to {@value OUTPUT_FILE}.
     *
    ...
    public static void main(String[] args) {
        ...
        TestCase[] cases = {
            ...
            new TestCase(
                ...
                50, "right",
                new int[]{45, 48, 52, 90, 150, 160}
            ),
            new TestCase(
                "Case 3", "Fairness challenge",
                15, "right",
                new int[]{10, 12, 14, 16, 100, 102}
            )
        };
    ...
    /**
     * Appends a complete section for one test case, covering all three
     * algorithm results.
     *
     * @param sb      the output builder
     * @param tc      the test case configuration
     * @param results the three {@link SchedulingResult} objects for this case
     *                (index 0 = FCFS, 1 = SSTF, 2 = SCAN)
     */
    private static void appendCaseSection(StringBuilder sb,
                                          TestCase tc,
        ...
        sb.append("  Requests     : ")
          .append(Arrays.toString(tc.requests)).append("\n");
        sb.append("=".repeat(70)).append("\n\n");
     ...
     * <ul>
     *   <li>Service order</li>
     *   <li>Compact head-movement path (all positions including disk-end waypoint)</li>
     *   <li>Step-by-step movement details</li>
     *   <li>Total head movement and average seek distance</li>
     * </ul>
     *
     * @param sb the output builder
    ...
    private static void appendAlgorithmResult(StringBuilder sb, SchedulingResult r) {
        ...
        sb.append(String.format("  Total movement: %d cylinders%n",
                r.getTotalMovement()));
        sb.append(String.format("  Avg seek dist : %.2f cylinders%n%n",
                r.getAverageSeekDistance()));
    }

    /**
     * Appends the summary comparison table covering all test cases and
     * algorithms.
     *
     * @param sb      the output builder
     ...
     */
    private static void appendSummaryTable(StringBuilder sb,
                                           TestCase[] cases,
                                           SchedulingResult[][] results) {
        ...
        String sep = "+" + "-".repeat(10)
                   ...
                   + "+" + "-".repeat(21)
                   + "+" + "-".repeat(21) + "+\n";
        String hdr = String.format("| %-8s | %-9s | %19s | %19s |%n",
    ...
    /**
     * Writes {@code content} to {@value OUTPUT_FILE} in the working directory.
     * Prints a warning to stderr if the write fails, but does not abort the
     * program.
     *
    ...
    private static void writeToFile(String content) {
        try (PrintWriter pw = new PrintWriter(new FileWriter(OUTPUT_FILE))) {
            ...
            System.err.println("Warning: could not write "
    ...
    private static class TestCase {
         ...
         */
        TestCase(String name, String description,
                 int initialHead, String direction, int[] requests) {
            this.name        = name;
