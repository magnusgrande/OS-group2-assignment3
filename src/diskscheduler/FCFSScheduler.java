 ...
 *
 * <p>Requests are serviced strictly in the order they arrive in the queue, with no reordering. FCFS
 * is simple and completely fair in the sense that no request is ever overtaken, but it does not
 * optimise head movement, which can lead to large total seek distances when consecutive requests
 * are far apart.
 */
public class FcfsScheduler {
   ...
   *
   * <p>The disk head starts at {@code initialHead} and moves to each cylinder in the order given by
   * {@code requests}.
   *
